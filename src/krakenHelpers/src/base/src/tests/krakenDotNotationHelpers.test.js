import { krakenDotNotationHelpers as h } from '../krakenDotNotationHelpers.js'


let convertFromDotNotation = h.fromDot
let convertToDotNotation = h.toDot
...
;
    ...
    expect(h.add(input, 'name', 'thing2')).toEqual(expectedOutput);
  });
